...
export const sampleSessionsWithCoordinates: ConsumptionSession[] = [
  ...
  },
  {
    ...
    concentrate: true,
    lavender: false,
    quantity: createQuantityValue('Pen', 5),
  ...
  },
  {
    ...
    purchased_legally: true,
    state_purchased: 'California',
    tobacco: 'American Spirit Menthol',
    kief: false,
    concentrate: false,
    lavender: false,
  ...
  },
  {
    ...
    concentrate: false,
    lavender: false,
    quantity: createQuantityValue('Edible', 10),
